    ...
    <div class="container-fluid p-0">
        ...
        <div class="container-fluid">
            ...
            <div class="row p-auto">
                ...
                <!-- Menu -->
                <div id="menu" class="col-2 col-md-2 col-lg-1 overflow-auto">
                ...
                <div id="contenu" class="col ">
                    <div class="row">
                        <div class="row row-cols-1 row-cols-md-3 row-cols-xl-4 g-2 gy-lg-2 mt-0">
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                        <div class="card-body px-0">
                                            <h5 class="card-title ps-3"><?php echo ($row["name_prod"]); ?></h5>
                                            <div>
                                                <form action="post_phindex2.php" method="post">
                                                    ...
                                                    <input class="achat" type="submit" value="" />
                                                </form>
                                            </div>
                                            <p class="pt-5 pe-3"><?php echo ($row["price_prod"]); ?> xpf</p>
                                        </div>
                                    </div>
                                </div>
                            <?php
                ...
                <div id="right_ticket" class="col-4 bg-white p-0 mt-2">
                    ...
                    ?> <div class="container bg-white mt-1 ps-3">
                            <div class="ticket row ">
                                <div class="col-md-2 col-lg-1  pe-0"><?php echo $row["quantite"] ?> X</div>
                                <div class="col-md-5 col-lg-7 px-0"><?php echo $row["name_prod"] . '-' . $price_prod . ' xpf' ?></div>
                                <div class="col-md-3 col-lg-3 pe-0 text-end"><?php echo (number_format($sommes_art, $decimals = 0, $dec_point = ".", $m = " ")) ?> xpf</div>
                                <div class="cross col-md-2 col-lg-1">
